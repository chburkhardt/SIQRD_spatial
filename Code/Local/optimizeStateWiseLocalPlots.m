function retval = optimizeStateWiseLocalPlots (parameterArray) %filelname 1 und filename 2
  tOpt = tic;
  ...
  if nargin == 0
    ...
    parameterArray{1}.model = "SIREDLiterature"; %"SIREDmod" | "SIRH" 
    parameterArray{1}.optimizationMode = "Germany"; %"Counties"|"Germany"|"Germany-and-Counties"
    parameterArray{1}.folderName = "SIREDLiterature_Textable_03-0430";
    ...
    parameterArray{1}.writeTexTableLocal = true;
...
##  
  ...
  paraNames = {"beta", "majorEvents", "contactRestrictions", "masks", "delta"};
  lb = [0.001 0 0 0 0]; %0.3
  ub = [0.55 1 1 1 0.01];  
  x0Cov = (lb+ub)/2; 

  %%%%%%%%%% SIR with Mask Restriction %%%%%%%%%%%%%
  parameterArray{1}.beta = 0.413723;
##  parameterArray{1}.majorEvents = 0.679362;
##  parameterArray{1}.contactRestrictions = 0.328799; 
##  parameterArray{1}.masks = 0.232719;
  %%%%%%%%%% SIR without Mask Restriction %%%%%%%%%%
##  parameterArray{1}.beta = 0.346959;
##  parameterArray{1}.majorEvents = 0.938406 ;
##  parameterArray{1}.contactRestrictions = 0.219112; 
##  parameterArray{1}.masks = 1;

  parameterArray{1}.beta = 0.4861;
  parameterArray{1}.majorEvents = 0.946671; 
  parameterArray{1}.contactRestrictions = 0.153201;
  parameterArray{1}.masks = 0.859563;
  parameterArray{1}.delta =0.00485523; 
