function varargout = optimizeAutomaticallySIRH_Website()
  ...
  parameterArray{1}.startDate = datenum([2020, 11, 11]);
  parameterArray{1}.endDateOpt = datenum([2020, 12, 09]);
  ...
  parameterArray{1}.paraNames = {"beta", "darkFigure"};
  parameterArray{1}.x0Cov = [0.157 0.4 10]; 
  parameterArray{1}.lb = [0 2];
  parameterArray{1}.ub = [3 10];
  ...
  parameterArray{1}.timeForFactorsDF = "twoWeeksToSimEnd"; %"lastWeek"|"twoWeeksToSimEnd"
  
  %"lastWeek" - fit deaths on last day of fitting period 
  %"twoWeeksToSimEnd" - fit deaths two weeks before fitting period ends
  parameterArray{1}.dayForDeathFit = "twoWeeksToSimEnd"; %"lastDay"|"twoWeeksToSimEnd"
   
  %"end" - slope of last day of fitting period is used
  %"lastWeek" -slope of last week in fitting period is used
  ...
  parameterArray{1}.PSOiterations = 450;
  ...
  parameterArray{1}.ub = parameterArray{1}.lb+3;  
  ...
  naiveGradientSearch(parameterArray);
